...
#   Step 17: aggregate energy data in the common time slot by energy categories and hourly
...
def worker(space):
    ...
    try:
        ...
        error_string = "Error in step 2.1 of space_energy_input_category.worker " + str(e)
        if cursor_system_db:
            cursor_system_db.close()
        if cnx_system_db:
            cnx_system_db.close()
    ...
    try:
        ...
        error_string = "Error in step 3.1 of space_energy_input_category.worker " + str(e)
        print(error_string)
        return error_string
    finally:
        if cursor_system_db:
    ...
    try:
        ...
        error_string = "Error in step 4.1 of space_energy_input_category.worker " + str(e)
        print(error_string)
        return error_string
    finally:
        if cursor_system_db:
    ...
    try:
        ...
        error_string = "Error in step 5.1 of space_energy_input_category.worker " + str(e)
        print(error_string)
        return error_string
    finally:
        if cursor_system_db:
    ...
    try:
        ...
        error_string = "Error in step 6.1 of space_energy_input_category.worker " + str(e)
        print(error_string)
        return error_string
    finally:
        if cursor_system_db:
    ...
    try:
        ...
        error_string = "Error in step 7.1 of space_energy_input_category.worker " + str(e)
        print(error_string)
        return error_string
    finally:
        if cursor_system_db:
    ...
    try:
        ...
        error_string = "Error in step 8.1 of space_energy_input_category.worker " + str(e)
        if cursor_energy_db:
    ...
    try:
        ...
        error_string = "Error in step 8.2 of space_energy_input_category.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    if virtual_meter_list is not None and len(virtual_meter_list) > 0:
        try:
            ...
            error_string = "Error in step 10 of space_energy_input_category.worker " + str(e)
            if cursor_energy_db:
                cursor_energy_db.close()
            if cnx_energy_db:
                cnx_energy_db.close()
    ...
    print("Step 17: aggregate energy data in the common time slot by energy categories and hourly")
    ...
    if len(aggregated_values) > 0:
        try:
            ...
            error_string = "Error in step 18.1 of space_energy_input_category.worker " + str(e)
            print(error_string)
            return error_string
        finally:
            if cursor_energy_db:

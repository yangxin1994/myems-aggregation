...
def main(logger):
    ...
    while True:
        ...
        try:
            ...
            logger.error("Error in step 1.1 of space_billing_output_item " + str(e))
            if cursor_system_db:
        ...
        try:
            ...
            logger.error("Error in step 1.2 of space_billing_output_item " + str(e))
            if cursor_system_db:
                cursor_system_db.close()
            if cnx_system_db:
                cnx_system_db.close()
        ...
        try:
            ...
            logger.error("Error in step 1.3 of space_billing_output_item " + str(e))
            if cursor_energy_db:
        ...
        try:
            ...
            logger.error("Error in step 1.4 of space_billing_output_item " + str(e))
        ...
        for space in space_list:
            ...
            try:
                ...
                logger.error("Error in step 2 of space_billing_output_item " + str(e))
            ...
            if len(billing_dict) > 0:
                try:
                    ...
                    logger.error("Error in step 6 of space_billing_output_item " + str(e))
                    # break the for space loop
                    break
